                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="center">{{$autores->id}}</td>
                                        <td title="Nome">{{$autores->name}}</td>
                                        <td title="Ano">{{$autores->ano_nascimento}}</td>
                                        <td title="Nacionalidade" id="center">{{$autores->nacionalidade}}</td>
                                        <td title="Sexo" id="center">{{$autores->sexo}}</td>
                                        <td id="center">
                                            <a href="{{URL::asset('autores/'. '1' . $autores->imagem)}}" 
                                               data-lightbox="{{URL::asset('autores/'. '1' . $autores->imagem)}}">
                                                <img src="{{URL::asset('autores/'. $autores->imagem)}}" />
                                            </a></td>
                                        <td id="center">
                                            <a href="{{route('autores.edit', $autores->id)}}" 
                                               data-toggle="tooltip" 
                                               data-placement="top"
                                               title="Alterar"><i class="fa fa-pencil"></i></a>
                                            &nbsp;<form style="display: inline-block;" method="POST" 
                                                        action="{{route('autores.destroy', $autores->id)}}"                                                        
